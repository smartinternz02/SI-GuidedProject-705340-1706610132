...
WebUI.click(findTestObject('Object Repository/TL_CURA_OBJ/Page_CURA Healthcare Service/input_visit_date'))

WebUI.click(findTestObject('Object Repository/TL_CURA_OBJ/Page_CURA Healthcare Service/td_30'))

WebUI.setText(findTestObject('Object Repository/TL_CURA_OBJ/Page_CURA Healthcare Service/textarea_comment'), 'fever')
