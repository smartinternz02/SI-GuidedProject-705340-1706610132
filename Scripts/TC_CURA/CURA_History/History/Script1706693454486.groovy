...
WebUI.callTestCase(findTestCase('TC_CURA/CURA_Makeappointment/appointment booking'), [('Hospital') : Hospital, ('Set_Date') : date
        , ('Comment') : comment], FailureHandling.STOP_ON_FAILURE)
